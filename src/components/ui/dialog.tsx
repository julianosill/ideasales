...
const DialogHeader = ({
  ...
  <div
    className={cn('flex flex-col gap-y-2 max-xs:text-center', className)}
    {...props}
  />
)
...
const DialogFooter = ({
  ...
  <footer
    className={cn(
      'mt-1 flex flex-wrap justify-end gap-2 max-xs:flex-col-reverse',
      className,
    )}
    {...props}
  />
